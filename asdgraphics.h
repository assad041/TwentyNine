...
/// Define: ASD_STRING_T
/// Define/typedef this to your preference to override asdgraphics's string type.
///
/// Defaults to std::string with C++ and char* with C.
#if 0
#define ASD_STRING_T char*
#endif
...
#ifndef ASD_INLINE
        #ifdef _MSC_VER
                #define ASD_INLINE __inline
        #else
                #define ASD_INLINE __inline__
        #endif
#endif
...
#ifndef gotoxy
/// Function: gotoxy
/// Same as <asdgraphics.locate>.
ASD_INLINE void gotoxy(int x, int y) {
        #ifdef __cplusplus
        asdgraphics::
        #endif
        locate(x,y);
...
/// under namespace asdgraphics. That is because some platforms have them defined
/// outside of asdgraphics.
namespace asdgraphics {
#endif

/**
* Defs: Internal typedefs and macros
* ASD_STRING_T - String type depending on which one of C or C++ is used
* ASD_PRINT(str) - Printing macro independent of C/C++
*/

#ifdef __cplusplus
        #ifndef ASD_STRING_T
                typedef std::string ASD_STRING_T;
        #endif // ASD_STRING_T

        inline void ASD_PRINT(ASD_STRING_T st) { std::cout << st; }

#else // __cplusplus
        #ifndef ASD_STRING_T
                typedef char* ASD_STRING_T;
        #endif // ASD_STRING_T

        #define ASD_PRINT(st) printf("%s", st)
#endif // __cplusplus
...
*/
const ASD_STRING_T ANSI_CLS = "\033[2J";
const ASD_STRING_T ANSI_BLACK = "\033[22;30m";
const ASD_STRING_T ANSI_RED = "\033[22;31m";
const ASD_STRING_T ANSI_GREEN = "\033[22;32m";
const ASD_STRING_T ANSI_BROWN = "\033[22;33m";
const ASD_STRING_T ANSI_BLUE = "\033[22;34m";
const ASD_STRING_T ANSI_MAGENTA = "\033[22;35m";
const ASD_STRING_T ANSI_CYAN = "\033[22;36m";
const ASD_STRING_T ANSI_GREY = "\033[22;37m";
const ASD_STRING_T ANSI_DARKGREY = "\033[01;30m";
const ASD_STRING_T ANSI_LIGHTRED = "\033[01;31m";
const ASD_STRING_T ANSI_LIGHTGREEN = "\033[01;32m";
const ASD_STRING_T ANSI_YELLOW = "\033[01;33m";
const ASD_STRING_T ANSI_LIGHTBLUE = "\033[01;34m";
const ASD_STRING_T ANSI_LIGHTMAGENTA = "\033[01;35m";
const ASD_STRING_T ANSI_LIGHTCYAN = "\033[01;36m";
const ASD_STRING_T ANSI_WHITE = "\033[01;37m";
...
///
/// See <Color Codes>
ASD_INLINE ASD_STRING_T getANSIColor(const int c) {
        switch (c) {
...
///
/// See <Color Codes>
ASD_INLINE void setColor(int c) {
#if defined(_WIN32) && !defined(ASD_USE_ANSI)
        HANDLE hConsole = GetStdHandle(STD_OUTPUT_HANDLE);
        SetConsoleTextAttribute(hConsole, (WORD)c);
#else
        ASD_PRINT(getANSIColor(c));
#endif
}

/// Function: cls
/// Clears screen and moves cursor home.
ASD_INLINE void cls(void) {
#if defined(_WIN32) && !defined(ASD_USE_ANSI)
        // TODO: This is cheating...
        system("cls");
#else
        ASD_PRINT("\033[2J\033[H");
#endif
}
/// Function: locate
/// Sets the cursor position to 1-based x,y.
ASD_INLINE void locate(int x, int y) {
#if defined(_WIN32) && !defined(ASD_USE_ANSI)
        COORD coord;
        coord.X = (SHORT)x-1;
...
/// Function: hidecursor
/// Hides the cursor.
ASD_INLINE void hidecursor(void) {
#if defined(_WIN32) && !defined(ASD_USE_ANSI)
...
/// Function: showcursor
/// Shows the cursor.
ASD_INLINE void showcursor(void) {
#if defined(_WIN32) && !defined(ASD_USE_ANSI)
        HANDLE hConsoleOutput;
        CONSOLE_CURSOR_INFO structCursorInfo;
        hConsoleOutput = GetStdHandle( STD_OUTPUT_HANDLE );
...
ASD_INLINE void msleep(unsigned int ms) {
#ifdef _WIN32
        Sleep(ms);
#else
...
#ifdef __cplusplus
/// Class: CursorHider
/// RAII OOP wrapper for <asdgraphics.hidecursor>.
